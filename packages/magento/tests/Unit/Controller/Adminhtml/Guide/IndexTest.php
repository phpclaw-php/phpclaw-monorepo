...
namespace PhpClaw\Magento\Tests\Unit\Controller\Adminhtml\Guide;
...
use PhpClaw\Magento\Controller\Adminhtml\Guide\Index;
...
final class IndexTest extends TestCase
{
    ...
    {
        self::assertSame('PhpClaw_Magento::phpclaw_guide', Index::ADMIN_RESOURCE);
    }
    ...
    public function test_execute_sets_page_title(): void
    {
        ...
        self::assertSame('PhpClaw: Guide', $prepended);
    }
}
