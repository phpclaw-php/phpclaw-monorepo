...
use PhpClaw\Magento\Controller\Adminhtml\Settings\Index;
...
final class IndexTest extends TestCase
{
    ...
    {
        self::assertSame('PhpClaw_Magento::phpclaw_settings', Index::ADMIN_RESOURCE);
    }
    ...
    public function test_execute_sets_page_title(): void
    {
        ...
        self::assertSame('PhpClaw: Settings', $prepended);
    }
}
