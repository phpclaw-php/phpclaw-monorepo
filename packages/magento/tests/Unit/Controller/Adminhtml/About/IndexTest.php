...
namespace PhpClaw\Magento\Tests\Unit\Controller\Adminhtml\About;
...
use PhpClaw\Magento\Controller\Adminhtml\About\Index;
...
final class IndexTest extends TestCase
{
    ...
    public function test_execute_calls_page_factory_create(): void
    {
    ...
    {
        self::assertSame('PhpClaw_Magento::phpclaw_about', Index::ADMIN_RESOURCE);
    }
    ...
    public function test_execute_sets_page_title(): void
    {
        ...
        self::assertSame('PhpClaw: About', $prepended);
    }
}
